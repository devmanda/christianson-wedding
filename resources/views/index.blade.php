...
@section('content')
    ...
    <section id="travel" class="flex flex-col justify-center items-center md:h-full w-full pt-12 md:pt-0 px-8 sm:px-0">
        ...
        <div class="pt-8 max-w-3xl">
            ...
            <p class="text-center">We recommend the <a target="_blank" class="text-emerald-800 underline" href="https://www.choicehotels.com/south-carolina/rock-hill/cambria-hotels/sc579">Cambria Hotel, Rock Hill - University Center.</a> It's the newest hotel in Rock Hill and close to all of our events. They do not do hotel blocks or codes, but is very reasonably priced. <br><br> We will also have a hotel block setup at Tru by Hilton in Rock Hill, <a class="text-underline text-amber-900" href="https://withjoy.com/amanda-and-paul-jun-25/accommodations">click here to reserve</a>. Uber and Lyft are easier to use closer to Charlotte, but are possible in the downtown Rock Hill area. We would recommend having a car or some other transportation plans.</p>
        </div>
    </section>
