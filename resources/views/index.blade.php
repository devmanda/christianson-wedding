...
@section('content')
    ...
    <section id="travel" class="flex flex-col justify-center items-center md:h-full w-full pt-12 md:pt-0 px-8 sm:px-0">
        ...
        <div class="pt-8 max-w-3xl">
            ...
            <p class="text-center">We have a hotel block setup at Tru by Hilton in Rock Hill, <a class="text-emerald-800 underline" href="https://withjoy.com/amanda-and-paul-jun-25/accommodations" target="_blank">click here to reserve</a>. 
