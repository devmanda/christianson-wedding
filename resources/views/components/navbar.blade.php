<nav class="transparent fixed md:w-full z-20 top-0 start-0 p-4">
    <div class="max-w-screen-xl flex flex-wrap items-center justify-center mx-auto md:p-6 border border-black bg-[#F4F1E1]">
        ...
        <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-sticky">
            <ul class="flex flex-col items-center justify-between p-4 md:p-0 mt-4 font-light border border-gray-100 rounded-lg md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0">
                ...
                <li class="mt-8 md:mt-0">
                    <a href="#rsvp" class="text-white bg-amber-900 hover:bg-amber-800 focus:ring-4 focus:outline-none focus:ring-emerald-300 font-medium rounded-lg text-sm px-4 py-2 text-center">RSVP Soon!</a>
                </li>
            </ul>
        </div>
    </div>
